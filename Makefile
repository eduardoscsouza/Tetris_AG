...
SOURCE= Main.cpp Game.cpp Board.cpp Tetromino.cpp include/InitShader.cpp
...
# Linux (default)
CFLAGS= -O3 -Wall -Wextra -Wno-unused-result -Wno-unused-parameter -Wno-ignored-qualifiers -DGL_GLEXT_PROTOTYPES
